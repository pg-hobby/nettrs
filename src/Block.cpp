...
/* NAME COLOR                     AXIS    LOCAL1  LOCAL2  LOCAL3   */
  {'I', TEXTURE_LIGHTBLUE_PATH,  {{1, 0}, {0, 0}, {2, 0}, {3, 0}}},
  {'O', TEXTURE_YELLOW_PATH,     {{1, 1}, {1, 0}, {2, 0}, {2, 1}}},
  {'S', TEXTURE_GREEN_PATH,      {{1, 1}, {1, 0}, {2, 0}, {0, 1}}},
  {'Z', TEXTURE_RED_PATH,        {{1, 1}, {0, 0}, {1, 0}, {2, 1}}},
  {'J', TEXTURE_BLUE_PATH,       {{1, 1}, {0, 0}, {0, 1}, {2, 1}}},
  {'L', TEXTURE_ORANGE_PATH,     {{1, 1}, {2, 0}, {0, 1}, {2, 1}}},
  {'T', TEXTURE_PURPLE_PATH,     {{1, 1}, {0, 1}, {1, 0}, {2, 1}}},
  {'i', TEXTURE_LIGHTGREEN_PATH, {{1, 0}, {0, 0}, {2, 0}, {2, 0}}},
  {'l', TEXTURE_PINK_PATH,       {{1, 1}, {1, 0}, {2, 1}, {2, 1}}},
};
